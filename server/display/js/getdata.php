<?php
	...
	$link_bmp = getLastPageLink('http://172.17.0.3:5000/bmpTable');
	$link_tsl = getLastPageLink('http://172.17.0.3:5000/tslTable');
	$link_dht = getLastPageLink('http://172.17.0.3:5000/dhtTable');
